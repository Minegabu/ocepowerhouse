    ...
    return (
        <div id="centerstuff">
            ...
            <div id="togther">
                <h1>Our Teams:</h1>
                <div id="together">
                    <a href='/about/mumbai'><Image id="Mumbai" alt="mumbai" src="/image.png" width={500} height={500}></Image></a>
                    <a href='/about/filler'><Image id="Mumbai" alt="mumbai" src="/IMG_4682.png" width={500} height={500}></Image></a>
                </div>
            </div>
        </div>
    )
